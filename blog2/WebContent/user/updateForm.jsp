...
<div class="container">
	<form action="/user?cmd=updateProc" method="post">
		...
		<div class="form-group">
			...
			<input type="text" value="${sessionScope.principal.address}" class="form-control" placeholder="Enter address"  name="address" required="required" id="address" readonly="readonly"/>
		</div>
